...
module.enable = function(self)
  ...
  if ShaguTargetCastbar then
    ShaguTargetCastbar:ClearAllPoints()
    ShaguTargetCastbar:SetPoint("TOPLEFT", TargetFrame, "TOPLEFT", 25, 25)
  end
    
  local castbar = CreateFrame("StatusBar", "ShaguPlayerCastbar", PlayerFrame)
  castbar:SetPoint("TOPRIGHT", PlayerFrame, "TOPRIGHT", -5, 25)
  ...
  local oldUpdate = PlayerFrame:GetScript("OnUpdate")
  PlayerFrame:SetScript("OnUpdate", function(arg)
